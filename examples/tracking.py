...
HSV_LOWER_VALUE = [126, 114, 92]
HSV_UPPER_VALUE = [209, 255, 255]
...
def get_args():
    ...
    parser.add_argument("-min", "--min_contour_area", type=float, default=100,
                        help="Minimum object contour area. This controls how small objects should be detected. Default = 2500")
    parser.add_argument("-max", "--max_contour_area", type=float, default=500,
                        help="Maximum object contour area. This controls how max objects should be detected. Default = 2500")
...
def main():
    ...
    tracker = color_tracker.ColorTracker(max_nb_of_objects=1, max_nb_of_points=200, debug=True)
